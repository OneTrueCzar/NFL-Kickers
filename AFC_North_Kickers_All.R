...
kickers <- load_pbp(seasons = TRUE) %>% 
  select(season, week, season_type, play_type, field_goal_result, score_differential_post, kick_distance, half_seconds_remaining, game_half, time, end_clock_time, quarter_end, kicker_player_name) %>% 
